...
public partial class NhtbookStoreContext : DbContext
{
    public NhtbookStoreContext()
    {
    }

    public NhtbookStoreContext(DbContextOptions<NhtbookStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=FENXIHALIN-2412\\SQLEXPRESS;Database=NHTBookStore;uid=ngyntra;pwd=163271; MultipleActiveResultSets=True; TrustServerCertificate=True ");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A62406A14D");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207682B49BA");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B8464539C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF42E287C4");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C39902A9A");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB231BF65D");
